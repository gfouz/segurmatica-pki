...
`;function Ge({form:e}){let r=Q(B).opt;const[i,s]=p.exports.useState("");return p.exports.useEffect(()=>{s(r)},[r]),c(A,{children:e&&e.map((t,o)=>i==t.option&&c(_e,{children:t.comp},o))})}const _e=g.div`
  ...
  justify-content: center;
  margin: 3em 0;
`,Fe=["ok","updated","enabled","associated","created","accepted","not-authorized","bad-request","Bad Request","Forbidden","Network Error","unprocessable","Unprocessable-data","not-found","Not Found","found by id","gotten-by-id"];function Ye({message:e}){const[n,r]=p.exports.useState("");return p.exports.useEffect(()=>{Fe.map(i=>{switch(e){case i:r(i);break;default:{r(e);break}}})},[e]),c(A,{children:c(Ie,{children:c("p",{className:e,children:n})})})}const Ie=g.div`
  margin: 2em;
  font-weight: bolder;
  text-transform: uppercase;
  text-align: center;
...
`,ke="http://localhost:5000",O=be.create({baseURL:ke,withCredentials:!1}),Ze={ci:"requerido 11 d\xEDgitos y ser mayor de 18 a\xF1os!",tome:"requeridos 4 d\xEDgitos para el tomo!",folio:"requeridos 4 d\xEDgitos para el folio!",name:"requiere nombres compuestos sin n\xFAmeros",tel:"requiere n\xFAmeros nacionales de 8 d\xEDgitos ",alpha:"requerido letras, n\xFAmeros y espacios",select:"esta selecci\xF3n es requerida",numeric:"requiere n\xFAmeros enteros o dec\xEDmales",email:"Debe contener @ y un formato correcto",password:"Debe tener 1 letra mayuscula y minuscula, 1 n\xFAmero y al menos 8 caracteres"};async function Je(e,n){try{const r=await O.post(e,n),{data:i}=r;return i}catch(r){return r==null?void 0:r.message}}async function et(e,n,r){try{return(await O.put(`/${n}/${r}`,e)).data}catch(i){return i.message}}async function tt(e,n){try{return(await O.get(`/${e}/${n}`)).data}catch(r){return r.message}}async function rt(e,n){try{return(await O.get(`/${e}/${n}`)).data}catch(r){return r.message}}async function nt(e){try{return(await O.get(e)).data}catch(n){return n.message}}async function st(e){try{return(await O.get(e)).data}catch(n){return n}}const it=(e,n)=>{n(e)};function at(e){const{buttonstate:n}=e,[r,i]=p.exports.useState(!1);return p.exports.useEffect(()=>{i(n)},[n]),c(Te,{children:c(Ue,{children:r?R("div",{children:[c(me,{size:"sm"}),c(ge,{children:"Loading..."})]}):c("span",{children:"Enviar"})})})}const Te=g.div`
  button:hover {
...
`,ot=e=>c(Ae,I(x({},e),{children:e.children})),Ae=g.h4`
...
`;function Be(e){return p.exports.createElement("svg",x({viewBox:"0 0 22 22",width:e.width||"1em",length:e.height||"auto"},e),p.exports.createElement("path",{fill:e.color,d:"M14.17 13.71l1.4-2.42c.09-.15.05-.34-.08-.45l-1.48-1.16c.03-.22.05-.45.05-.68s-.02-.46-.05-.69l1.48-1.16c.13-.11.17-.3.08-.45l-1.4-2.42c-.09-.15-.27-.21-.43-.15l-1.74.7c-.36-.28-.75-.51-1.18-.69l-.26-1.85a.364.364 0 00-.35-.29h-2.8c-.17 0-.32.13-.35.3L6.8 4.15c-.42.18-.82.41-1.18.69l-1.74-.7c-.16-.06-.34 0-.43.15l-1.4 2.42c-.09.15-.05.34.08.45l1.48 1.16c-.03.22-.05.45-.05.68s.02.46.05.69l-1.48 1.16c-.13.11-.17.3-.08.45l1.4 2.42c.09.15.27.21.43.15l1.74-.7c.36.28.75.51 1.18.69l.26 1.85c.03.16.18.29.35.29h2.8c.17 0 .32-.13.35-.3l.26-1.85c.42-.18.82-.41 1.18-.69l1.74.7c.16.06.34 0 .43-.15zM8.81 11c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM21.92 18.67l-.96-.74c.02-.14.04-.29.04-.44 0-.15-.01-.3-.04-.44l.95-.74c.08-.07.11-.19.05-.29l-.9-1.55c-.05-.1-.17-.13-.28-.1l-1.11.45c-.23-.18-.48-.33-.76-.44l-.17-1.18a.216.216 0 00-.21-.2h-1.79c-.11 0-.21.08-.22.19l-.17 1.18c-.27.12-.53.26-.76.44l-1.11-.45a.23.23 0 00-.28.1l-.9 1.55c-.05.1-.04.22.05.29l.95.74a3.145 3.145 0 000 .88l-.95.74c-.08.07-.11.19-.05.29l.9 1.55c.05.1.17.13.28.1l1.11-.45c.23.18.48.33.76.44l.17 1.18c.02.11.11.19.22.19h1.79c.11 0 .21-.08.22-.19l.17-1.18c.27-.12.53-.26.75-.44l1.12.45c.1.04.22 0 .28-.1l.9-1.55c.06-.09.03-.21-.05-.28zm-4.29.16a1.35 1.35 0 11.001-2.701 1.35 1.35 0 01-.001 2.701z"}))}function $e(e){return p.exports.createElement("svg",x({viewBox:"0 0 20 20",width:e.width||"1em",length:e.height||"auto"},e),p.exports.createElement("path",{fill:e.color,d:"M3 19h18v2H3v-2zm10-5.828L19.071 7.1l1.414 1.414L12 17 3.515 8.515 4.929 7.1 11 13.17V2h2v11.172z"}))}function _(e){return p.exports.createElement("svg",x({viewBox:"0 0 22 22",width:e.width||"1em",length:e.height||"auto"},e),p.exports.createElement("path",{fill:e.color,d:"M21 8v12.993A1 1 0 0 1 20.007 22H3.993A.993.993 0 0 1 3 21.008V2.992C3 2.455 3.449 2 4.002 2h10.995L21 8zm-2 1h-5V4H5v16h14V9zM8 7h3v2H8V7zm0 4h8v2H8v-2zm0 4h8v2H8v-2z"}))}const ze=g.div`
  ...
  ${e=>e.column&&T`
    ...
    `}
`;function Le(e){const n=Q(B),r=Q($),{setOption:i}=n,{reverse:s}=r,t=[{option:"a\xF1adir",icon:c(Be,{})},{option:"mostrar",icon:c($e,{})},{option:"buscar",icon:c(_,{})},{option:"asociado",icon:c(_,{})},{option:"asociado habilitado",icon:c(_,{})},{option:"habilitados",icon:c(_,{})},{option:"por nombre",icon:c(_,{})}];return c(A,{children:c(ze,I(x({},e),{children:c("div",{className:"nav",children:t.map((o,a)=>R("div",{className:"nav__item",children:[c("div",{className:"nav__icon",children:o.icon}),c("div",{children:c("button",{className:"nav__button",onClick:()=>{i(o.option),s()},children:c("a",{className:"nav__link",children:o.option})})})]},a))})}))})}function Ne(){const e=Q($),{st:n}=e;return c(Pe,{children:c("div",{className:n?"opened":"closed",children:c(Le,{column:!0})})})}const Pe=g.nav`
  .opened {
    position: absolute;
    top: 0;
    left: 0;
...
`,Me=({st:e,reverse:n})=>c(qe,{children:R("button",{onClick:()=>n(),children:[c("div",{className:e?"opened":"closed"}),c("div",{className:e?"opened":"closed"}),c("div",{className:e?"opened":"closed"})]})}),qe=g.div`
  button {
    position: absolute;
    right: 0;
    top: 0;
...
`;function ct(e){const n=Q(B),r=Q($),{opt:i}=n,{st:s,reverse:t,setFalse:o}=r;return R(De,I(x({},e),{children:[R("header",{children:[R("h2",{className:"header__title",children:["Admin...",e.name]}),c(Me,{st:s,reverse:t})]}),c(Ne,{}),c("main",{onClick:o,children:e.children}),c("footer",{children:i})]}))}const De=g.div`
